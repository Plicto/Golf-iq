...
import {
  WEBGL_VISUAL_WATER_SHORELINE_WIDTH_METERS,
  WEBGL_VISUAL_WATER_SURFACE_LIFT_METERS,
  createVisualWatercourseWorld,
} from "./webgl-watercourse-visual-v8.js";

export { createVisualWatercourseWorld };
export const WEBGL_VISUAL_WATERCOURSE_RENDER_VERSION = "direct-ribbon-v9";
...
export function replaceVisualWatercourseGeometry(geometry, world) {
  ...
  let shorelineTriangles = 0;
  const groups = world.waterSurfaceGroups ?? (
